   ...
   user_data = templatefile(
       "./cloud-init.tpl", 
        { 
            ...
            COS_BUCKET_ENDPOINT       = data.ibm_cos_bucket.cos_bucket.s3_endpoint_private,
            HMAC_ACCESS_KEY_ID        = data.ibm_resource_key.cos_resource_key.credentials["cos_hmac_keys.access_key_id"],
            HMAC_SECRET_ACCESS_KEY_ID = data.ibm_resource_key.cos_resource_key.credentials["cos_hmac_keys.secret_access_key"],
